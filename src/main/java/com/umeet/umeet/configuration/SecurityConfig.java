...
//                .antMatchers("/profile/*").permitAll()
                ...
                .antMatchers("/profile/modifyPass").permitAll()
                .antMatchers("/profile/sendEmail").permitAll()
                .antMatchers("/profile/resetPassView").permitAll()
                .antMatchers("/profile/modifyPass").permitAll()
                .antMatchers("/profile/newCode").permitAll()
