...
INSERT INTO `messages` (`id`, `name`, `text`, `id_channel`, `id_user`) VALUES ('1', 'ipsum', 'Qui qui aut deleniti temporibus suscipit et quis. Quidem qui dolores magni quisquam voluptatem quo ratione. Et eum perferendis rerum est quis. Enim est rerum debitis blanditiis beatae.', '1', '1');
INSERT INTO `messages` (`id`, `name`, `text`, `id_channel`, `id_user`) VALUES ('2', 'similique', 'Sed earum amet nulla repellat qui ratione occaecati. Assumenda voluptatem sunt tenetur quod. Rerum doloremque qui dolor sit. Mollitia dolores repudiandae ut nihil exercitationem hic molestias.', '2', '2');
INSERT INTO `messages` (`id`, `name`, `text`, `id_channel`, `id_user`) VALUES ('3', 'iste', 'Beatae et non voluptatum vero molestiae numquam mollitia. Iusto cupiditate nisi a eum et quia id. Odio quod vitae mollitia voluptas voluptatem itaque facilis.', '3', '3');
INSERT INTO `messages` (`id`, `name`, `text`, `id_channel`, `id_user`) VALUES ('4', 'odit', 'In exercitationem voluptatum hic velit et cumque consequatur doloribus. Beatae commodi rerum pariatur enim in ea itaque. Quo eum quis commodi deserunt. Qui quos adipisci voluptates libero.', '4', '4');
INSERT INTO `messages` (`id`, `name`, `text`, `id_channel`, `id_user`) VALUES ('5', 'ut', 'Odio fugiat est ut placeat impedit. Fugiat quibusdam accusantium consequatur consequatur. Beatae adipisci repellat fuga quam voluptas non. Ipsum ab illum dolorem.', '5', '5');
